    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        self.fp8_linear = init_fp8_linear_kernel(
            # Prefer B12X only when it supports this layer; retain the original
            # selector fallback for MiMo audio/vision and narrow KV projections.
            force_kernel=(B12xFp8BlockScaledMMKernel
                          if os.environ.get("HOMELAB_MIMO_B12X_FP8") == "1"
                          else None),
