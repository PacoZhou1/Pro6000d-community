...
class UnquantizedLinearMethod(LinearMethodBase):
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module) -> None:
        from vllm.model_executor.layers.homelab_mimo_dense import prepare_homelab_dense
    ...
    def apply(
        ...
        from vllm.model_executor.layers.homelab_mimo_dense import use_homelab_dense
        if use_homelab_dense(layer, x, bias):
            return torch.ops.vllm.homelab_mimo_dense_bf16(x, layer.weight)
